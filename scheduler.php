...
<head>
    ...
    <script src="js/lib/schedule/dist/jquery.schedule.js"></script>
        ...
        <section class="content">
            ...
            <div class="top_sMenu">
                ...
                <div class="topleft">
                    ...
                    <select name="teacherChoice" id="teacherChoice">
                    ...
                    <!-- <select name="whereChoice" id="whereChoice" style="display: none;">
                ...
                <div class="topright">
                    <p>예약 <span id="TICKETTING_COUNT">0</span></p>
                    <p>출석 <span id="TICKETTING_IN">0</span></p>
                    <p>결석 <span id="TICKETTING_NO">0</span></p>
                    <!-- <p>취소 <span id="TICKETTING_cancel">0</span></p> -->
                    <p>휴일 <span class="rect"></span></p>
                    <button id="solo_s_view_button" onclick="location.href='scheduler.php'" class="active">개인레슨 스케줄</button>
                    <button id="group_s_view_button" onclick="location.href='scheduler_group.php'">그룹레슨 스케줄</button>
                </div>
            </div>

            <!-- 스케줄러 -->
            <div id="schedule-date" class="jqs-demo mb-3">
                <i class="fas fa-arrow-left arrowIcon left"></i>
                <i class="fas fa-arrow-right arrowIcon right"></i>
            </div>
...
<div id="pop_div1" class="form-pop">
    <section class="state_sec">
        ...
        <div>
            ...
            <div>
                <button type="button" class="pop_submit chulsuk">적 용</button>
                <button type="button" class="pop_close chulsuk">닫 기</button>
            </div>
        </div>
    </section>
    <section class="state_sec">
        ...
        <div>
            ...
            <div>
                <button type="button" class="pop_submit gyeolsuk">적 용</button>
                <button type="button" class="pop_close gyeolsuk">닫 기</button>
            </div>
        </div>
    </section>
    <section class="state_sec">
        ...
        <div>
            ...
            <div>
                <button type="button" class="pop_submit cancel">적 용</button>
                <button type="button" class="pop_close cancel">닫 기</button>
            </div>
        </div>
    </section>
</div>
...
<div id="pop_div2" class="form-pop">
    <section>
        ...
        <article class="ticketting hid">
            ...
            <div class="count">
                <p>참석회원 수 : <span>0명</span></p>
                <p>출석 : <span>0명</span></p>
                <p>예약결석 : <span>0명</span></p>
            </div>
            <div class="table">
                <table>
                    <thead>
        ...
        <div class="input">
            ...
            <div class="col1">
                ...
                <div style="width:300px;">
                    <input type="text" id="solo_searchName" class="solo_searchName" style="float:left;" placeholder="클릭해주세요." readonly maxlength="10">
                    <div class="NotMemberGender" 
                         style="padding:0 10px;margin:4px 0;width:150px;display:none;height:32px;float:left;display: flex;align-items: center;justify-content: space-around;">
                        <input type="radio" name="gender" id="NotMemberGender_male" value="male" checked>
                        <label for="NotMemberGender_male" style="font-size:14px;">남자</label>
                        <input type="radio" name="gender" id="NotMemberGender_female" value="female">
                        <label for="NotMemberGender_female" style="font-size:14px;">여자</label>
                    </div>
                </div>
            </div>
            ...
            <div class="col2">
                ...
                <input type="text" name="pop_teacherChoice" id="pop_teacherChoice" readonly style="border: none;">
            </div>
            <div class="col3">
                ...
                <input type="text" name="ticketChoiceLabel" id="ticketChoiceLabel" style="display:none;" readonly>
            </div>
            <div class="col4">
                <h3>이용권 정보</h3><br>
                <p class="UV_detail_info">
                    <span>담당: 권성은 / 만료: 2020.12.30</span><br>
                    <span>이용: 3 / 잔여: 31 / 예약: 0</span>
                </p>
            </div>
...
<div class="group form-pop">
    ...
    <div class="input">
        ...
        <div class="col2">
            ...
            <select name="groupClassWhere" id="groupClassWhere">
                <option value="">선택해주세요</option>
                <option value="room1">ROOM1</option>
                <option value="room2">ROOM2</option>
                <option value="room3">ROOM3</option>
        ...
        <div class="col5">
            ...
            <p>
                ...
                <input type="text" name="groupClassPay" id="groupClassPay" placeholder="수업수당">
            </p>
        </div>
        <div class="col6">
        ...
        <div class="col8">
            <label for="groupClassMemo">메 모</label>
            <textarea rows="4" name="groupClassMemo" id="groupClassMemo"></textarea>
        </div>
        <div class="btnSet">
            <div class="jqs-options-close">등 록</div>
            <div class="jqs-options-remove">삭 제</div>
            <div class="jqs-options-cancel">닫 기</div>
...
<choiceManager style="display:none;">
    <h2>트레이너 선택</h2>
    <ul>
        <!-- js -->
        <li>관리자</li>
